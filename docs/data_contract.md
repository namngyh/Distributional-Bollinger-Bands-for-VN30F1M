...
2. **Timezone và latency:** timestamp đầu nến đã được người dùng xác nhận, nhưng timezone nguồn và độ trễ nhận dữ liệu/đặt lệnh chưa được xác minh. Phân tích giao dịch về sau phải mô hình hóa latency phù hợp.
