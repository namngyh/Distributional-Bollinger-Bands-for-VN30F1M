...
Phase 0–2 đã triển khai và kiểm thử. Phase 3/5/6/7A/7B/8: full user-run 1m/5m đã xác minh bằng checkpoint/artifact hashes và báo cáo. Phase 4A–4B: thư viện fit đã dùng trong Phase 5. DEC-005 đã khóa hai mô hình trước khi mở final. [Đánh giá final Phase 8](phase8_final_assessment.md) ghi nhận: 5m Mixture hiệu chỉnh PIT không vượt Empirical HL30 trên final primary pinball; 1m coverage tổng thể gần danh nghĩa nhưng exceedance còn tụ thành cụm. Không chọn lại mô hình hoặc tham số từ 2025–2026. Phase 9–10 chưa triển khai và cần quyết định riêng. Người dùng xác nhận timestamp là đầu nến; timezone nguồn và rollover vẫn chưa xác minh, như ghi trong [data contract](data_contract.md).
