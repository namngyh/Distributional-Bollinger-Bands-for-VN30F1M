...
%=====================================================================
\section{Kế hoạch Phase 9 (đề xuất, chưa duyệt)}

Mọi kết quả Phase 9 mang tính khám phá. DEC-005 và PHASE8-V1 giữ nguyên.

\begin{itemize}[nosep]
\item \textbf{9A:} chẩn đoán $z_t$ trên tập xác thực: hàm tự tương quan của $z$ và $z^2$, $|z|$ theo giờ trong phiên, PIT theo giờ và theo trạng thái biến động.
